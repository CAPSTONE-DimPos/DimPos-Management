            ...
            <CardHeader>
              <CardTitle className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <Button type="button" variant="outline" onClick={() => document.getElementById("upload-image")?.click()}> <Upload className="w-4 h-4 mr-2" /> Tải lên </Button>
                  {imagePreview && <Button type="button" variant="destructive" onClick={handleRemoveImage}>Xóa</Button>}
                </div>
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input {...register("code")} readOnly className="bg-muted cursor-not-allowed" />
              </div>
              ...
              {selectedType === 2 && (
                <div>
                  ...
                  <Controller
                    ...
                    name="parentId"
                    render={({ field }) => {
                      const selectedCat = parentCategories.find((cat) => cat.id === field.value);
