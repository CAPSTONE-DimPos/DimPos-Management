...
}: React.ComponentProps<"div"> & { asChild?: boolean } )
{
  ...
  return (
    <Comp
      ...
      className={ cn(
        "font-semibold text-sidebar-label ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-4 text-xs outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
